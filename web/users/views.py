...
class UserListView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request, template_name="users/users-list.html", context={"users": users}
        )
...
class UserAddView(views.View):
    def get(self, request, *args, **kwargs):
        form = UserForm()
        return render(
            request, template_name="users/user-form.html", context={"form": form}
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        return render(
            ...
            context={"message": "Вы успешно добавили пользователя"},
        )
...
class UserEditView(views.View):
    def get(self, request, user_id, *args, **kwargs):
        ...
        return render(
            ...
            context={"form": form, "user_id": user_id, "is_edit": True},
        )
    ...
    def post(self, request, user_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно изменили пользователя"},
        )
...
class UserDeleteView(views.View):
    def get(self, request, user_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно удалили пользователя"},
        )
