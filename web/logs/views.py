...
from logs.forms import (
    AnomalousEventMainPageSearchForm,
    AnomalousEventSearchForm,
    LogFileForm,
    LogFileSearchForm,
    LogTypeForm,
    LogTypeSearchForm,
    OneTimeScanAnomalousEventSearchForm,
    SearchPatternForm,
    SearchPatternSearchForm,
)
...
class GenerateTestAnomalousEventView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        if log_files:
            ...
            search_patterns = log_file.type.search_patterns.all()
            anomalous_event = AnomalousEvent.objects.create(
                text=text,
                count_of_events=None,
                log_file=log_file,
                detected_search_pattern=search_patterns[
                    randint(0, len(search_patterns) - 1)
                ],
            )
            notification_types = (
                anomalous_event.detected_search_pattern.notification_types.all()
            )
        ...
        return render(
            ...
            context={"message": "Вы успешно сгенерировали аномальное событие"},
        )


class MainPageView(views.View):
    def get(self, request, *args, **kwargs):
        form = AnomalousEventMainPageSearchForm()
        start_datetime = datetime.datetime.now(
            tz=ZoneInfo(key="Asia/Yekaterinburg")
        ).replace(hour=0, minute=0, second=0, microsecond=0)
        end_datetime = start_datetime + datetime.timedelta(days=1)
        anomalous_events = AnomalousEvent.objects.filter(
            detected_datetime__gt=start_datetime,
            detected_datetime__lt=end_datetime,
            log_file__one_time_scan=False,
            count_of_events=None,
        )
        qsstats = QuerySetStats(anomalous_events, date_field="detected_datetime")
        logs_metrics = qsstats.time_series(
            start_datetime, end_datetime, interval="minutes"
        )
        logs_metrics = list(
            filter(lambda x: x[1] > 0 or x[0].minute % 30 == 0, logs_metrics)
        )
        ...
        return render(
            ...
            context={
                "form": form,
                "logs_metrics": json.dumps(logs_metrics),
                "start_datetime": start_datetime,
                "end_datetime": end_datetime,
                "anomalous_events": anomalous_events[:6],
            },
        )

    def post(self, request, *args, **kwargs):
        form = AnomalousEventMainPageSearchForm(request.POST)
        if not form.is_valid():
            return self.get(self, request, *args, **kwargs)
        text, start_datetime, end_datetime, log_file, log_type, search_pattern = (
...
class AnomalousEventListView(views.View):
    def get(self, request, *args, **kwargs):
        anomalous_events = AnomalousEvent.objects.filter(
            log_file__one_time_scan=False, count_of_events=None
        )
        ...
        return render(
            request,
            template_name="logs/anomalous-events/anomalous-events-list.html",
    ...
    def post(self, request, *args, **kwargs):
        ...
        if start_datetime:
            anomalous_events = anomalous_events.filter(
                detected_datetime__gt=start_datetime
            )
        if end_datetime:
            anomalous_events = anomalous_events.filter(
        ...
        if search_pattern:
            anomalous_events = anomalous_events.filter(
                log_file__type__search_patterns=search_pattern
            )
        paginator = Paginator(anomalous_events, 50)
        page = paginator.get_page(self.request.GET.get("page"))
        return render(
...
class AnomalousEventDeleteView(views.View):
    def get(self, request, anomalous_event_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно удалили аномальное событие"},
        )
...
class LogFileListView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/log-files/log-files-list.html",
            context={"log_files": log_files, "form": form},
        )
...
class LogFileAddView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/log-files/log-file-form.html",
            context={"form": form},
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно добавили лог-файл"},
        )
...
class LogFileEditView(views.View):
    def get(self, request, log_file_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/log-files/log-file-form.html",
            context={"form": form, "log_file_id": log_file_id, "is_edit": True},
        )
    ...
    def post(self, request, log_file_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно изменили лог-файл"},
        )
...
class LogFileDeleteView(views.View):
    def get(self, request, log_file_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно удалили лог-файл"},
        )
...
class LogTypeListView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/log-types/log-types-list.html",
            context={"log_types": log_types, "form": form},
        )
...
class LogTypeAddView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/log-types/log-type-form.html",
            context={"form": form},
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно добавили протокол / ПО"},
        )
...
class LogTypeEditView(views.View):
    def get(self, request, log_type_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/log-types/log-type-form.html",
            context={"form": form, "log_type_id": log_type_id, "is_edit": True},
        )
    ...
    def post(self, request, log_type_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно изменили протокол / ПО"},
        )
...
class LogTypeDeleteView(views.View):
    def get(self, request, log_type_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно удалили протокол / ПО"},
        )
...
class SearchPatternListView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/search-patterns/search-patterns-list.html",
            context={"search_patterns": search_patterns, "form": form},
        )
    ...
    def post(self, request, *args, **kwargs):
        ...
        if notification_type:
            search_patterns = search_patterns.filter(
...
class SearchPatternAddView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/search-patterns/search-pattern-form.html",
            context={"form": form},
        )
...
class SearchPatternEditView(views.View):
    ...
    def post(self, request, search_pattern_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно изменили поисковый паттерн"},
        )
...
class SearchPatternDeleteView(views.View):
    def get(self, request, search_pattern_id, *args, **kwargs):
        ...
        return render(
            request,
            template_name="success.html",
            context={"message": "Вы успешно удалили поисковый паттерн"},
        )
...
class OneTimeScanListView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/one-time-scans/one-time-scans-list.html",
...
class OneTimeScanAddView(views.View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request,
            template_name="logs/one-time-scans/one-time-scan-form.html",
            context={"form": form},
        )
...
class OneTimeScanAnomalousEventListView(views.View):
    def get(self, request, log_file_id, *args, **kwargs):
        ...
        anomalous_events = AnomalousEvent.objects.filter(
            log_file__id=log_file_id, count_of_events=None
        )
        paginator = Paginator(anomalous_events, 50)
        page = paginator.get_page(self.request.GET.get("page"))
        return render(
            request,
            template_name="logs/one-time-scans/one-time-scan-anomalous-events-list.html",
            context={"page": page, "form": form, "log_file_id": log_file_id},
        )

    def post(self, request, log_file_id, *args, **kwargs):
        form = OneTimeScanAnomalousEventSearchForm(
            request.POST, log_file_id=log_file_id
        )
        if not form.is_valid():
            return self.get(self, request, *args, **kwargs)
        anomalous_events = AnomalousEvent.objects.filter(
        ...
        text, search_pattern = form.cleaned_data.values()
        if text:
            anomalous_events = anomalous_events.filter(text__icontains=text)
        if search_pattern:
            anomalous_events = anomalous_events.filter(
